...
async def main():
    ...
    raw_clause = "The client agrees to unconditionally indemnify and hold harmless the provider for any and all damages, without any financial cap or limitation of liability."
